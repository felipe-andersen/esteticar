        ...
        <section about=" barra lateral esquerda " className="  flex w-80 fixed mt-16 jfif  flex-col hidden   sm md:flex lg xl 2xl  bg-white border-r border-zinc-200  ">
            ...
            <div about="coluna de botões " className="  w-full  h-full overflow-scroll scroll  flex flex-col  overflow-x-hidden">
                ...
                <div className=" flex flex-col  h-max p-5 ">
                    ...
                    <Link href={"/"} about="link" className="w-min  h-16 text-zinc-800 flex flex-row rounded-full hover:bg-zinc-200   rounded px-6 gap-5">

                        <div about='icone' className="w-min  h-full flex items-center justify-center">

                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-home"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                    ...
                    <Link href="/PDV" target="_blank" about="link" className="w-full  h-16 flex flex-row rounded-full hover:bg-zinc-200 w-min h-16 rounded px-6 gap-5">
                        ...
                        <div about="nome" className="h-full w-min flex items-center justify-center">
                            ...
                            <p className="text-zinc-800">PDV</p>
                    ...
                    <Link href={"/team"}  className="w-min  h-16 rounded-full flex flex-row hover:bg-orange-300 px-6 gap-5">
                        ...
                        <div about="nome" className="h-full w-min flex items-center justify-center">
                            ...
                            <p className="text-zinc-800">Pátio</p>
                    ...
                    <Link href={"/services"} about="butões" className="rounded-full px-6 gap-5 w-minl  h-16 flex flex-row hover:bg-zinc-200">
                    ...
                    <div about="butões" className="rounded-full px-6 gap-5 w-full  h-16 flex flex-row hover:bg-zinc-200 items-center">
