import { result } from "@/vendor/date-fns/config";
...
export function TopBar ({pageName}:Props) {
    return (
        ...
        <div about='barra superior' className='w-full z-40  flex flex-col fixed bg-white  z-50 '>
            <div className='w-full h-14 sm:h-16 flex items-center justify-between p-6 border-b border-zinc-150  bg-white'>
                ...
                <div className='flex gap-2 flex'>
                    <Link href={'/subscribe'} className="hidden sm:flex items-center text-[13px] justify-center bg-violet-500 hover:opacity-100 text-white h-9 px-3 rounded font-semibold  opacity-70 mr-5">Upgrade</Link>
