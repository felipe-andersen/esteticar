    ...
    <main className=' wwinf bg-[#f6f8fa]  scroll ml-80 mt-16 overflow-scroll '>
        ...
        <div className='w-full h-min relative  p-6 flex flex-col '>
            ...
            <div className='flex flex-col mb-10 gap-3 '>
                ...
                <p className='text-zinc-400'>Lista de serviços cadastrados</p>
            ...
            <div className='flex  gap-3 mb-6 items-center w-full justify-between' >
                ...
                <button className='text-black h-10 w-min px-3 whitespace-nowrap text-sm font-semibold rounded border border-neutral-400 text-black'>
            ...
            <div className=' h-16 flex items-center justify-between border-b border-zinc-300 mb-6'>
                ...
                <div className='text-lg'>Lista de serviços</div>
            ...
            <div className='flex justify-between mb-6'>
                ...
                <h2 className='font-medium text-md'>Lavagem</h2>
            ...
            <div className='flex justify-between mb-6'>
                ...
                <h2 className='font-medium text-lg'>Pintura</h2>
            ...
            <div className='flex justify-between mb-6'>
                ...
                <h2 className='font-medium text-lg'>Polimento</h2>
            ...
            <div className='flex justify-between mb-6'>
                ...
                <h2 className='font-medium text-lg'>Eletrônicos</h2>
            ...
            <div className='h-40 w-full bg-white rounded mb-6 gap-6 flex flex-col items-center justify-center'>
                ...
                <button className='h-10 border border-black w-min px-6 whitespace-nowrap  text-sm font-semibold rounded '>Adicionar serviço</button>
            </div>
