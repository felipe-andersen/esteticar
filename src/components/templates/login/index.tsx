    ...
    return (
        <div className="bg-[#97cbff] dffd  w-[100vw]  h-[110vh] py-16 px-36 flex flex-col items-end">
            ...
            <div className="w-[450px] bg-white py-16 px-10 flex flex-col items-center rounded">
                ...
                <h1 className="text-center text-2xl font-medium mb-4">Criar uma nova conta</h1>

                <p className="text-center max-w-80 mb-6">Você está prestes a criar uma nova conta na Esticar</p>
                ...
                <button className="h-10 w-full bg-blue-400  text-lg rounded text-white font-medium mb-6 ">Começar</button>

                <div className="flex items-center text-center gap-2 mb-6 text-[#4d6992]">
                    Já tem uma conta?

                    <button className=" text-black h-8 flex px-3 bg-zinc-100 rounded items-center text-xs font-medium">Login</button>

                </div>

                <p className="text-sm text-[#4d6992] leading-6">Ao se inscrever, você reconhece que concorda com nossos <Link href="/terms" className="underline">Termos de Serviço</Link> e <Link href="/terms" className="underline">Política de Privacidade</Link>.</p>
            </div>
